    ...
    <main style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      {isReporting && reportingStage === 'adjust' && (
        ...
        >
          ...
          >
            ...
            >
              {/* Outer Pin Shell (Figma Primary Crimson) */}
              <path 
      ...
      <div style={{ position: 'relative', zIndex: 3, pointerEvents: 'none', width: '100%', height: '100%' }}>
        ...
        >
          ...
          {/* Center Search / Location Capsule Column */}
          <div 
            style={{
              flex: 1,
              backgroundColor: '#FFFFFF',
          ...
          >
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <span style={{ fontSize: '14px', fontWeight: 600, color: '#1F2937', lineHeight: '1' }}>
                {reportingStage === 'adjust' && searchQuery ? searchQuery : 'Ajah, Lagos'}
              </span>
            </div>
          </div>

          {/* Right Cloud Icon Button Circle */}
          <button 
          ...
          >
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#000000" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M17.5 19A5.5 5.5 0 0 0 13 10h-1a7 7 0 1 0-13 4 5.5 5.5 0 0 0 5.5 5h12z"></path>
            </svg>
          </button>
        </div>
