...
export default function Auth({ onAuthComplete }: AuthProps) {
  ...
  const handleFinalSubmit = () => {
    // Pass the created username or fallback to display name up to App.tsx
    const finishedUser = formData.username.replace('@', '') || formData.displayName || 'Solomon';
    onAuthComplete(finishedUser);
  };
      ...
      <div className="auth-card">
        ...
        {step === 3 && (
          <div className="auth-step-panel text-center">
            ...
            <button onClick={handleFinalSubmit} className="primary-action-btn">Get Started</button>
          </div>
        )}
