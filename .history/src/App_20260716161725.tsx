    ...
    <main style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 2, pointerEvents: 'none', width: '100%', height: '100%' }}>
        ...
        <div className='navBar'>
          ...
          {!isReporting && !selectedReport && (
          <button className="report-trigger-btn-camera" style={{ pointerEvents: 'auto' }} onClick={() => setIsReporting(true)}>
            <img src={cameraIcon} alt="CameraIcon" width={24} height={24} />Report Flooding
          </button>
        )}
