...
export default function App() {
  ...
  // FIXED: No more static fallback initial string values
    ...
    if (navigator.geolocation) {
      ...
      navigator.geolocation.getCurrentPosition(
        ...
        (error) => {
          ...
          setNewLocationName('Lagos Center (Permission Denied)');
          setCurrentCoords([3.4064, 6.4654]); // Safe default center if blocked
        },
        { enableHighAccuracy: true, timeout: 10000 }
      );
    } else {
      setNewLocationName('Geolocation not supported by browser');
    }
  }, [isReporting]);
  ...
  const handleReportSubmit = async (e: React.FormEvent) => {
    ...
    // FIXED: Uses the live coordinates captured from the browser directly
    ...
    setNewLocationName('Fetching live location...'); // Reset baseline state
  };
          ...
          <div className="report-container-panel" style={{ pointerEvents: 'auto' }}>
            ...
            <form onSubmit={handleReportSubmit}>
              ...
              <footer className="form-footer">
                <button type="submit" className="submit-btn" disabled={isSubmitting || newLocationName === 'Locating your position...'}>
