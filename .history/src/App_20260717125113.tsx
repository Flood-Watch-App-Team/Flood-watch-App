    ...
    <main style={{ position: 'relative', width: '100vw', height: '100vh', overflow: 'hidden' }}>
      ...
      <div style={{ position: 'relative', zIndex: 3, pointerEvents: 'none', width: '100%', height: '100%' }}>
        ...
        >
          ...
          <button 
            onClick={() => alert(`Active User: @${currentUser}`)}
            style={{
              width: '40px',
              height: '40px',
              borderRadius: '50%',
          ...
          >
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M17.5 19C18.9556 19 20.3056 18.232 21.0333 17 Motion..." stroke="#1F2937" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
          </button>
        </div>
