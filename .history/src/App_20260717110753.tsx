    ...
    return (
      ...
      >
        <div style={{
            ...
            {onboardingStep === 1 && (
              <div style={{ flex: 1, display: 'flex', flexDirection: 'column' }}>
                ...
                <div style={{ position: 'relative', margin: '24px 0', textAlign: 'center' }}>
                  ...
                  <span style={{ position: 'absolute', backgroundColor: '#FFFFFF', padding: '0 12px', fontSize: '11px', color: '#94A3B8', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    Sign up with email
                  </span>
                </div>
          ...
          <div style={{ height: '24px', width: '100%', display: 'flex', justifyContent: 'center', alignItems: 'center', padding: '8px', backgroundColor: '#FFFFFF' }}>
