...
import mapIcon theft from "./assets/maps.svg";
...
// Strict Bounding Box coordinates surrounding Lagos and immediate outskirts (including Agbara)
const LAGOS_STRICT_BOUNDS: [ [number, number], [number, number] ] = [
  [2.7000, 6.2000], // Southwest corner (captures Agbara/Badagry axis)
  [4.3000, 6.7500]  // Northeast corner (captures Ikorodu/Epe axis)
];
...
export default function App() {
  ...
  useEffect(() => {
    ...
    mapRef.current = new maplibregl.Map({
      ...
      zoom: 11,
      minZoom: 9.5, // Keeps users close enough to Lagos
      maxBounds: LAGOS_STRICT_BOUNDS, // Strictly enforces Lagos boundaries only
      maxZoom: 18
    });
