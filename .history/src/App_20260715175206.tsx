...
// 1. CHANGE: Switch from mapbox-gl to maplibre-gl
import maplibregl from 'maplibre-gl';
import 'maplibre-gl/dist/maplibre-gl.css';

import type { FloodReport } from './type';

// 2. CHANGE: Use your free MapTiler Key here
const MAPTILER_KEY = 'https://api.maptiler.com/tiles/cadastre/?key=sdtBMUsCK9bQkLIjtyQX#6.7/46.67057/8.17041';
...
const LAGOS_FLOOD_REPORTS: FloodReport[] = [
  {
    ...
    imageUrl: <iframe width="500" height="300" src="https://api.maptiler.com/tiles/outdoor/?key=sdtBMUsCK9bQkLIjtyQX#5.0/44.23484/8.93702"></iframe>,
    waterLevel: "High",
    status: "Active"
  }
];
...
export default function App() {
  ...
  const [newWaterLevel, setNewWaterLevel] = useState<'Low' | 'Medium' | 'High'>('Medium');
  ...
  useEffect(() => {
    ...
    // 3. CHANGE: Instantiate maplibregl instead of mapboxgl
    mapRef.current = new maplibregl.Map({
      container: mapContainerRef.current,
      // MapTiler free dark style link
