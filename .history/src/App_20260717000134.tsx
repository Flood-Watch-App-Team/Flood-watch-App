...
export default function App() {
  ...
  // Search state for the top main floating search bar
  const [mainSearchQuery, setMainSearchQuery] = useState('');
  const [displayedLocation, setDisplayedLocation] = useState('Ajah, Lagos');
  ...
  // Handle Search Input from main top search bar
